...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/haru-256/grpc-soft-ware-design-202307/gen/go/proto/address_book/v1"
	http "net/http"
	strings "strings"
)
...
func NewAddressBookServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AddressBookServiceClient {
	...
	addressBookServiceMethods := v1.File_proto_address_book_v1_address_book_proto.Services().ByName("AddressBookService").Methods()
